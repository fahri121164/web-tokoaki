...
class Header_transaksi_model extends CI_Model {
    ...
    {
        return $this->db->get_where('header_transaksi', ['id' => $id])->row_array();
    }

    
    public function ubahMenu()
    {
        $header_transaksi = $this->input->post('status_bayar', true);
        $this->db->set('status_bayar', $header_transaksi);
        $this->db->where('id', $this->input->post('id'));
        $this->db->update('header_transaksi');
    }
